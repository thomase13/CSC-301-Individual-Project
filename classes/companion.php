...
class Companion{
	...
	public function index() {
		...
		while($record=$result->fetch()) {
			...
			echo '<a href="delete.php?id='.$record['id'].'" style="color:red;">Delete this companion</a><br><br>';
		}
	}
	...
	public function detail() {
		...
		echo '<img src='.$record['picture'].' alt="Companion Picture" style="height:400px"><br> ';
